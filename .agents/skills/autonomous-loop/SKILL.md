...
- `.agents/skills/verify-loop/SKILL.md` — 자기 수정 루프, 4-Level 완료 기준
- `.agents/skills/planning/SKILL.md` — 개발 계획 수립
- `.agents/skills/code-accuracy/SKILL.md` — 코드 정확성 검증
- `.agents/skills/notify-user/SKILL.md` — 에스컬레이션 시 Slack-First 모드로 사용자 응답 수신
