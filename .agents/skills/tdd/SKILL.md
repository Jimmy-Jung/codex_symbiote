...
- `.codex/project/context.md` — 테스트 프레임워크, 컨벤션
...
- AGENTS.md에 정의된 Planner 역할이 TDD 사이클을 가이드
- AGENTS.md에 정의된 Reviewer 역할이 테스트 품질을 검증
- AGENTS.md에 정의된 Implementer 역할이 Green 단계 구현
