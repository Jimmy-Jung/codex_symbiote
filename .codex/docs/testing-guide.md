...
1. Codex CLI 설치 완료
2. `codex --enable multi_agent` 실행 후 재시작
3. 프로젝트 trust 설정: `codex trust /path/to/codex_symbiote`
4. `.codex/config.toml` 파일 존재
5. `.codex/agents/*.toml` 핵심 역할 파일 존재 (예: explorer, worker, monitor, analyst, planner, implementer)
...
- `.codex/project/context.md` 및 `.codex/skills/planning/SKILL.md` 참조
