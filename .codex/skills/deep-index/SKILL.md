---
name: deep-index
description: 코드베이스 인덱싱 및 구조 분석. 프로젝트를 스캔하여 모듈별 요약, 의존성 그래프, 진입점 맵을 생성하고 context.md를 풍부하게 합니다. Use when onboarding to a new codebase or when project structure needs documentation.
source: origin
---
...
- `.codex/project/codebase-index.md`에 결과 저장
